            ...
            <div class="col-lg-12 col-12">
                <div class="box">
                    <form class="form" action="{{ route('order-request.store') }}" method="POST"
                        ...
                        @csrf
                        <div class="box-body">
                            <h4 class="box-title text-info mb-0"><i class="ti-user me-15"></i> {{ __('Customer Details') }}
                            </h4>
                            <hr class="my-15">
                            {{-- <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="selectpicker  @error('request_type') is-invalid @enderror"
                                            ...
                                            <option value="1" {{ old('request_type') == 1 ? 'selected' : '' }}>
                                                {{ __('Order') }}</option>
                                            <option value="3" {{ old('request_type') == 3 ? 'selected' : '' }}>
                                                {{ __('Cancelled') }}</option>
                                        </select>
                                        @error('request_type')
                                            <span class="invalid-feedback" role="alert">
                                        ...
                                        <select class="form-control select2  @error('language_id') is-invalid @enderror"
                                            ...
                                            @if ($language)
                                                @foreach ($language as $item)
                                                    <option value={{ $item->id }}
                                                        {{ old('language_id') == $item->id || $item->slug == 'fi' ? 'selected' : '' }}>
                                                        {{ $item->name }}</option>
                                                @endforeach
                                            @else
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <input type="text" name="start_date"
                                                    ...
                                                    value="{{ old('start_date') }}" data-date-format="dd-mm-yyyy"
                                                    id="datepicker">
                                                @error('start_date')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ __($message) }}</strong>
                                            ...
                                            <div class="bootstrap-timepicker">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="start_time"
                                                        ...
                                                        value="{{ old('start_time') }}" placeholder="00:00"
                                                        id="StartTimePicker">
                                                    @error('start_time')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ __($message) }}</strong>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <input type="text" name="end_date"
                                                    ...
                                                    value="{{ old('end_date') }}" data-date-format="dd-mm-yyyy"
                                                    id="">
                                                @error('end_date')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ __($message) }}</strong>
                                        ...
                                        <div class="col-md-6">
                                            <div class="bootstrap-timepicker">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{ old('end_time') }}" name="end_time"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="tax_rate" id="taxRate"
                                            ...
                                            <option value="10" {{ old('tax_rate') == '10' ? 'selected' : '' }}>10%
                                            </option>
                                            <option value="24" {{ old('tax_rate') == '24' ? 'selected' : '' }}>24%
                                            </option>
                                        </select>
                                        @error('tax_rate')
                                            <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="price_incl_tax" id="priceIncTax"
                                        ...
                                        <select name="driver_id"
                                            ...
                                            @if ($driver)
                                                @foreach ($driver as $item)
                                                    <option value={{ $item->id }}
                                                        {{ old('driver_id') == $item->id ? 'selected' : '' }}>
                                                        {{ $item->name }}</option>
                                                @endforeach
                                            @else
                                ...
                                <div class="form-group">
                                    <div class="col-md-6">
                                        <input type="checkbox" id="md_checkbox_4"
                                            {{ old('mobility_restrictions') == 'on' ? 'checked' : '' }}
...
@section('footer-script')
    <script>
        $(document).ready(function() {
            ...
            // $('#StartTimePicker , #presetInLocTimePicker').timepicker({
            //     timeFormat: 'hh:mm'
            // })
