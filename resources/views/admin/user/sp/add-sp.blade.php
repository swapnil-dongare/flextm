                ...
                <div class="box">
                    <form class="form" action="{{ route('organization.store') }}" method="POST"
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <h4 class="box-title text-info mb-0 mt-20"><i class="ti-save me-15"></i> Address</h4>
                                <hr class="my-15">
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                {{-- </div> --}}
                                {{-- <div class="col-md-6"> --}}
                                <h4 class="box-title text-info mb-0 mt-20"><i class="ti-save me-15"></i> Invocing Address
                                </h4>
                                <hr class="my-15">
                                <div class="row">
                                    <div class="col-12">
