                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea rows="5" name="maintenance" value=""
                                    class="form-control @error('maintenance') is-invalid @enderror" placeholder="{{__('Maintenance')}}">{{ $equipment->maintenance }}</textarea>
                                @error('maintenance')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ __($message) }}</strong>
                                    </span>
